...
internal static class CustomPushFixtureModel
{
    internal static CustomPushEncoder DailyEncoder(int templateId = 93)
    {
        ...
        model.AddTemplate(new(templateId, "captured-one-phase-layout", 12, 12, 2, 2, false, null, 9, null, null, null, null)
        ...
        for (int i = 0; i < names.Length; i++)
            model.AddField(9, "DAILY_CUSTOM_PUSH_1P", new(i + 1, names[i], i == 0 ? "DateTime" : "UInt32", i == 0 ? 0 : -3, 0, "1P", 5));
        model.Freeze();
